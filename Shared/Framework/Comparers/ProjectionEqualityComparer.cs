...
namespace Tamasi.Shared.Framework
{
	...
	public static class ProjectionEqualityComparer
	{
		...
		/// <returns>
		/// A comparer which will compare elements by projecting each element to its key, and
		/// comparing keys
		/// </returns>
	...
	/// <summary>
	/// Comparer which projects each element of the comparison to a key, and then compares those
	...
	public class ProjectionEqualityComparer<TSource, TKey> : IEqualityComparer<TSource>
	{
		...
		/// <summary>
		/// Creates a new instance using the specified projection, which must not be null. The
		/// default comparer for the projected type is used.
		/// </summary>
		...
		/// <summary>
		/// Compares the two specified values for equality by applying the projection to each value
		/// and then using the equality comparer on the resulting keys. Null references are never
